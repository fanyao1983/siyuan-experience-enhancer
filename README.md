...
建议更新下插件
- **修复Ai大纲与思源bug冲突**
发现了思源的2个长期以来存在的bug,测试了从很早以前(我只测到v3.2.1版本)就存在了
更新了AI大纲功能-以避免大量轮询触发该问题
问题1.使用中因为大量数据,会出现"你的数据是安全的,如果持续出错汇报的bug",该问题由updateblock这个api的空指针造成的已向官方报告并得到确认 https://github.com/siyuan-note/siyuan/issues/16705
问题2.打开思源软件出现屏幕闪烁,"在打开docker面板状态下关闭软件"重启软件就出现这个问题,不确定是什么问题,待官方确认(目前我的折中方案是昨天采取的打开软件的时候及时关闭,并不是每次都能及时关闭)
